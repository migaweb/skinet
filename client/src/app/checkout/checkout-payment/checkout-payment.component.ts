...
export class CheckoutPaymentComponent implements AfterViewInit, OnDestroy {
  ...
  ngAfterViewInit(): void {
    this.stripe = Stripe('pk_test_51HnP4YJH2B9atWn1nT2mT6SYN6vOkCpNbTWJgusVj3TMVXk78iEWv0o5usKpzEEskiOg98jQLleeuSSqh7S5hmxm00aVh4PPTS');
  ...
  async submitOrder(): Promise<any> {
    ...
    try {
      ...
      if (paymentResult.paymentIntent) { // Payment success
